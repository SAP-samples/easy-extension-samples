package com.sap.cx.boosters.easy.extension.metaspacetest.populator

import com.sap.cx.boosters.easy.extension.metaspacetest.priceconversion.service.PriceConversionService
    ...
    void populate(SOURCE source, TARGET target) throws ConversionException {
        ...
        if (baseStore.hasProperty('cryptoCurrency')) {
            ...
            if(null!=price){
                ...
                if(cryptoCurrency) {
                    def cryptoPriceValue = priceConversionService.getCryptoPrice(price.value, price.currencyIso, cryptoCurrency.isocode) * 10000
